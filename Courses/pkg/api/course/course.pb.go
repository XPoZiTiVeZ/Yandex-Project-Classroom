...
const file_Common_Proto_course_proto_rawDesc = "" +
	"\n" +
	"\x19Common/Proto/course.proto\x12\x06course\x1a\x1fgoogle/protobuf/timestamp.proto\"\xb4\x02\n" +
	"\x06Course\x12\x1b\n" +
...
var (
	...
	file_Common_Proto_course_proto_rawDescData []byte
)

func file_Common_Proto_course_proto_rawDescGZIP() []byte {
	file_Common_Proto_course_proto_rawDescOnce.Do(func() {
		file_Common_Proto_course_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_Common_Proto_course_proto_rawDesc), len(file_Common_Proto_course_proto_rawDesc)))
	})
...
func file_Common_Proto_course_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_Common_Proto_course_proto_rawDesc), len(file_Common_Proto_course_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   13,
			NumExtensions: 0,
			NumServices:   1,
